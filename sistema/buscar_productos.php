...
<body>
  ...
  <section id="container">
    ...
    <a href="registro_producto.php" class="btnNew"><i class="fas fa-cart-plus"></i>  Crear producto</a>
          ...
          ?>
            <tr class="row<?php echo $data["codproducto"]; ?>">
              ...
              <td>
                ...
                |
                <a class="link_edit" href="editar_producto.php?id=<?php echo $data["codproducto"]; ?>"><i class="fas fa-user-edit"></i> Editar</a>
                |
                <a class="link_delete del_product" href="#" product="<?php echo $data["codproducto"]; ?>"><i class="fas fa-user-times"></i> Eliminar</a>
              <?php } ?>
