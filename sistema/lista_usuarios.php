...
<body>
	...
	<section id="container">
		...
		<a href="registro_usuario.php" class="btnNew"><i class="fas fa-user-plus"></i> Crear usuario</a>
			...
			<table>
				...
				<?php 
					...
					<tr>
						...
						<td>
							<a class="link_edit" href="editar_usuario.php?id=<?php echo $data["idusuario"]; ?>"><i class="fas fa-user-edit"></i> Editar</a>
