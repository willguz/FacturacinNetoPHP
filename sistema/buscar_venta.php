...
<body>
  ...
  <section id="container">
    ...
    <h1><i class="fas fa-folder"></i> Lista de ventas</h1>
    <a href="buscar_venta.php" class="btnNew"><i class="fas fa-folder-plus"></i> Nueva venta</a>
        ...
        <?php 
          ...
          if($result > 0){
            ...
            while ($data = mysqli_fetch_array($query)) {
              if ($data["estatus"] == 1) {
                $estado = '<sapan class="pagada">Pagada</span>';
              }else{
                $estado = '<sapan class="anulada">Anulada</span>';
              }
          ?>
            <tr id="row_<?php echo $data['nofactura']; ?>">
              ...
              <td>
                <div class="div_acciones">
                  ...
                  <?php }} ?>
                  <div class="div_devolucion">
                    <a class="btn_devolucion" href="devolucion.php?fac=<?php echo $data["nofactura"]; ?>"><i class="fas fa-hand-holding-usd"></i></a>
                  </div>
                </div>
              </td>
            </tr>
